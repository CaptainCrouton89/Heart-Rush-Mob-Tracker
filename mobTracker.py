...
class TrackerApp():
    ...
    def add_widgets(self):
        ...
        save = tkm.Button(self.header, text="Keybinds", command=self.open_keybinds, takefocus=0)
...
class MobShelf(tk.Frame):
    ...
    def __init__(self, master, app, config=None, takefocus=1):
        super().__init__(master=master, height=140, width=4000, borderwidth=3, relief=tk.RAISED, 
    ...
    def add_widgets(self):
        ...
        content = tk.Frame(master=self, width=1500)
